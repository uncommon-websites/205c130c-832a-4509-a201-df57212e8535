<footer class="bg-[#FBFBF9] pt-20">
  ...
  <div class="bg-[#FCEE4F] py-12 px-4 relative overflow-hidden">
    ...
    <!-- Decorative Flowers -->
    <div class="flex flex-col items-center gap-4 mt-12 text-black">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C14.5 2 16 4.5 16 7C16 9.5 14.5 12 12 12C9.5 12 8 9.5 8 7C8 4.5 9.5 2 12 2Z" />
        <path d="M12 22C9.5 22 8 19.5 8 17C8 14.5 9.5 12 12 12C14.5 12 16 14.5 16 17C16 19.5 14.5 22 12 22Z" />
        <path d="M2 12C2 9.5 4.5 8 7 8C9.5 8 12 9.5 12 12C12 14.5 9.5 16 7 16C4.5 16 2 14.5 2 12Z" />
        <path d="M22 12C22 14.5 19.5 16 17 16C14.5 16 12 14.5 12 12C12 9.5 14.5 8 17 8C19.5 8 22 9.5 22 12Z" />
      </svg>
       <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C14.5 2 16 4.5 16 7C16 9.5 14.5 12 12 12C9.5 12 8 9.5 8 7C8 4.5 9.5 2 12 2Z" />
        <path d="M12 22C9.5 22 8 19.5 8 17C8 14.5 9.5 12 12 12C14.5 12 16 14.5 16 17C16 19.5 14.5 22 12 22Z" />
